...
class BagOfWordsTest(unittest.TestCase):
    ...
    def word_list():
        return ['test', 'text', 'written', 'demonstr',
                ...
                'real', 'real', 'real', 'written', 'demonstr',
                'text', 'filter', 'test', 'demonstr',
                'written', 'test', 'written', 'test', 'real',
                'filter', 'real', 'test', 'demonstr', 'real']

    @staticmethod
    def vocabulary():
        return ['real', 'test', 'written', 'demonstr',
                'filter', 'text', 'stem']

    @staticmethod
    def cat_wordlist_dict():
        word_list = BagOfWordsTest.word_list()
        cat_word_dict = {'A': [word_list[0:16],
                               word_list[8:20],
                               word_list[18:28]],
                         'B': [word_list[6:13],
                               word_list[13:24],
    ...
    def test_category_bow_dict(self):
        ...
        A_bow_ref = np.array([[4., 2., 3., 2., 2., 2., 1.],
                              [3., 2., 3., 2., 1., 1., 0.],
                              [3., 3., 2., 1., 1., 0., 0.]])
        B_bow_ref = np.array([[4., 1., 2., 0., 0., 0., 0.],
                              [1., 3., 2., 2., 2., 1., 0.]])
        C_bow_ref = np.array([[2., 1., 1., 1., 1., 0., 1.],
                              [4., 2., 4., 3., 2., 2., 1.]])
        D_bow_ref = np.array([[1., 1., 1., 1., 1., 0., 1.]])
...
class TopicFeatureTransformTest(unittest.TestCase):
    ...
    def test_estimate(self):
        ...
        S_inv_mat_ref = np.array([[0.04730404, 0., 0.],
                                  [0., 0.10312641, 0.],
                                  [0., 0., 0.25752625]])
        feature_trans = TopicFeatureTransform(topic_dim=3)
